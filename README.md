...
| `TRUNCATION_FLOOR_SHARE` | `1/3` | Part de sa source qu'un fragment tronqué doit atteindre pour être retenu. Forfait sans effet mesuré entre 0,25 et 0,45, cf. [llm.md](documentation/llm.md). |
