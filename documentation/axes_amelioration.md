...
7. **60 QUESTIONS NE TRANCHENT PAS UN RÉGLAGE**, et 130 non relues ne valent pas
   ...
   **CORRECTION DU 25 SEPTEMBRE 2026 (VÉRIF-40)** : faux pour le jeu de contrôle,
   dont les **30** questions portent `reviewed: true`, et pour **8** des 138 du jeu
   de réglage. Non relues : **190 sur 228**.
...
8. **60, 130 ET 26 QUESTIONS NE TRANCHENT PAS UN RÉGLAGE**, et `reviewed: false`
   sur les trois jeux.
   **CORRECTION DU 25 SEPTEMBRE 2026 (VÉRIF-40)** : « `reviewed: false` » ne vaut
   pas pour les trois jeux — les **30** questions du jeu de contrôle sont relues,
   et **8** des 138 du jeu de réglage. Non relues : **190 sur 228**, mesuré par
   `yaml.safe_load`.
...
```bash
.venv/bin/python <répertoire temporaire>/mut/banc.py
```
