...
## Unitaire — 603 tests, aucune dépendance
...
> ```
>
> `mesuré` le 8 septembre 2026 : **603** tests sur **40** fichiers, et les deux
> comptes de la recette — la somme par fichier et le total que `pytest` annonce
> — concordent. Relevé antérieur : **562** sur **38**, le 7 septembre 2026.
>
